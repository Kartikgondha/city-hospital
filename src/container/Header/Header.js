                    ...
                    <div className="container d-flex align-items-center">
                        ...
                        <nav id="navbar" className="navbar order-last order-lg-0">
                            <ul>
                                ...
                                <li>
                                    <NavLink className="nav-link scrollto active" to={"/department"}>Deparment</NavLink>
                                </li>
                                <li>
                        ...
                        <NavLink to="/appointment" className="appointment-btn scrollto"><span className="d-none d-md-inline">Make an</span>
                            Appointment</NavLink>
                        <NavLink to={"/loginform"} className="appointment-btn scrollto"> <span className="d-none d-md-inline">Login/ Signup</span></NavLink>
                    </div>
                </header>
            </div>
        </div>
